...
const Info = () => {
  ...
  const [imageUrlAvatar, setImageUrlAvatar] = useState<{ url: any; file: any, status: boolean }>(
    { url: user?.avatar, file: undefined, status: false }
  );
  const [imageUrlLogo, setImageUrlLogo] = useState<{ url: any; file: any, status: boolean }>({
    url: user?.logo,
