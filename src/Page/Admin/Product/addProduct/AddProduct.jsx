...
// @ts-ignore
const AddProduct= ({ callBack, state, data }) => {
  ...
  const onFinishFailed = (values) => { console.log(values, '21wed') };
  return (
              ...
              >
                ...
                >
                  <Select
                    ...
                    defaultValue={categories?.find((item) => item._id == dataValue?.cate_id)?._id}
                  >
                    {categories?.map((item) => (
